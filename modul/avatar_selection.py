...
def OpenOtherAva():
	...
	file = shutil.move(filename, 'assets/images/avatars/')
	imag = 'assets/images/avatars/{f}'.format(f= file)
	return imag
...
if __name__ == "__main__":
	...
	avtr4 = ImageTk.PhotoImage(Image.open('assets/images/avatars/a4.png').resize((size, size)), Image.ANTIALIAS)
